...
import com.mathos.jnemcic.mathos.MyCoursesAdapter;
...
public class MyCourses extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static List<Course> listCourseMyCourses = new ArrayList<>();
    Course course;
    public static MyCoursesAdapter adapter;

    public static List<String> myCourses =
            new ArrayList<String>(Arrays.asList(new String[]{
            "Algoritmi na grafovima", "Dizajniranje i modeliranje baze podataka", "Funkcionalno programiranje", "Grupiranje podataka",
                    "Klijentsko web programiranje", "Matematička teorija računarstva", "Složenost algoritama", "Teorija odlučivanja"}));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < myCourses.size(); ++i) {
            course = new Course(myCourses.get(i), R.drawable.c);
            if(!listCourseMyCourses.contains(course))
                listCourseMyCourses.add(course);
        }

        listView = (ListView) findViewById(R.id.list);
        adapter = new MyCoursesAdapter(this, listCourseMyCourses);
